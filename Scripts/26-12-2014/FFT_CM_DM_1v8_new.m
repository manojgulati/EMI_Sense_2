...
File_Path = 'C:\Users\Puneet\Dropbox\EMI_Sense_2\EMI_SENSE_2 [Data]\Redpitaya [Data]\Trace-10 [16-12-2014]\ROUTER\R3_';
No_of_traces = 100;
...
set(gcf,'Color','w');  %Make the figure background white
% subplot(2,1,1);
semilogx(f1,10*log10(1000*((AMPY_DM.^2)/10^6)),'rx');
set(gca,'xlim',[0 1]);
% ylabel('Amplitude|Y-DM|(dBm)');
% title('Amplitude Spectrum of EMI');
% legend('DM');
