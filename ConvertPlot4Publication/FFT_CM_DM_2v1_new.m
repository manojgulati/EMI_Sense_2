...
Path1 = 'C:\Users\manojg\Dropbox\EMI_Sense_2\EMI_SENSE_2 [Data]\Redpitaya [Data]\Trace-14 [03-01-2015]\';
Path2 = 'LC1_';
...
% Function to plot as per IEEE publication specifications in 4 formats eps, fig, PDF and png
saveas(gcf,strcat(File_Path,'_visualize_X1_',int2str(Points),'.bmp'));
