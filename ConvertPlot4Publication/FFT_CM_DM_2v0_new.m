...
File_Path = 'C:\Users\manojg\Dropbox\EMI_Sense_2\EMI_SENSE_2 [Data]\Redpitaya [Data]\Trace-13 [26-12-2014]\LC_EARTH';
No_of_traces = 100;
...
% Function to plot as per IEEE publication specifications in 4 formats eps, fig, PDF and png
saveas(gcf,strcat(File_Path,'_visualize_W5_',int2str(Points),'.bmp'));
